            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="mt-8 p-4 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <p className="text-blue-700 text-sm">
                  The map integration and store management features will be available in Phase 3. 
                  For now, you can explore the authentication system and role-based access control.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="flex items-center p-3 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <div>
                <p className="text-sm font-medium text-blue-900">Phase 2: Authentication</p>
                <p className="text-xs text-blue-700">In Progress 🔄</p>
              </div>
            </div>
            <div className="flex items-center p-3 bg-gray-50 rounded-lg border border-gray-200">
              <div className="flex-shrink-0 w-3 h-3 bg-gray-400 rounded-full mr-3"></div>
              <div>
                <p className="text-sm font-medium text-gray-700">Phase 3: Map Integration</p>
